      ...
      <body>
        <div class="receipt-card">
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 12px; color: #475569; margin-bottom: 15px;">
            ...
            <tr>
              <td style="padding: 2px 0;"><strong>Cashier:</strong> ${txn.cashier?.full_name || '—'}</td>
              <td style="padding: 2px 0; text-align: right;"><strong>Payment:</strong> <span style="text-transform: uppercase; font-weight: 600;">${isCredit ? 'CREDIT (UDHAAR)' : txn.payment_method}</span></td>
            </tr>
          </table>
